			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
							<a class="nav-link active" href="#">Lista de animales</a>
						</li>
					</ul>
				</div>
			</div>
                ...
                <?php foreach($animales as $animal):?>
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-body">
                                <h6 class="card-title"><?= $animal["id"] ?></h6>
                                <h6 class="card-title">nombre:<?= $animal["nombre"] ?></h6>
                                <h6 class="card-title"><?= $animal["edad"] ?></h6>
                                <h6 class="card-title"><?= $animal["descripcion"] ?></h6>
                                <h6 class="card-title"><?= $animal["tipo"] ?></h6>
                                <h6 class="card-title"><?= $animal["id_producto"] ?></h6>
                                <p class="card-text"></p>
                                               ...
                                               <div class="col-9">
                                                    <form action="<?= site_url('/animal/editar/'.$animal["id"]) ?>" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="tipo" value="<?= $animal["tipo"] ?>">
                                                        </div>
